...
fn enum_variants_exist() {
    ...
    #[cfg(any(feature = "function_item", feature = "all_node_types"))]
    let _ = NodeType::FunctionItem;
    #[cfg(any(feature = "struct_item", feature = "all_node_types"))]
    let _ = NodeType::StructItem;
    #[cfg(any(feature = "impl_item", feature = "all_node_types"))]
    let _ = NodeType::ImplItem;
    #[cfg(any(feature = "mod_item", feature = "all_node_types"))]
    let _ = NodeType::ModItem;
    #[cfg(any(feature = "block", feature = "all_node_types"))]
    let _ = NodeType::Block;
    #[cfg(any(feature = "identifier", feature = "all_node_types"))]
